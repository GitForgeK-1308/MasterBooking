...
async def avatar_ac(
    ...
    ] = override_get_user_avatar_service
...
async def test_upload_avatar_allowed_formats(
    ...
    assert (
        user_from_database.avatar_storage_key
        is not None
    )

    avatar_path = (
        avatar_storage.uploads_dir
        / user_from_database.avatar_storage_key
    )
...
async def test_upload_avatar_replaces_old_avatar(
    ...
    first_content = make_image_bytes(
        "PNG"
    )
    ...
    assert (
        user_after_first_upload.avatar_storage_key
        is not None
    )
    ...
    second_content = make_image_bytes(
        "JPEG"
    )
    ...
    assert (
        user_after_second_upload.avatar_storage_key
        is not None
    )
