...
class MasterService:
    ...
    async def get_master_by_id(
        ...
        return await self.repository.get_by_id(master_id)
    ...
    async def create_master(
        ...
        city_name, district_name = await self._resolve_location(
        ...
        return await self.repository.create(master)
    ...
    async def update_master(
        ...
        city_id_provided = "city_id" in update_data
        district_id_provided = "district_id" in update_data

        if city_id_provided or district_id_provided:
            ...
            elif city_id is None or district_id is None:
                raise ValueError("Город и район должны быть выбраны вместе.")

            else:
                city, district = await self.location_service.validate_location(
                    city_id=city_id,
        ...
        return await self.repository.update(master)
    ...
    async def create_master_profile(
        ...
        existing_master = await self.repository.get_by_user_id(current_user.id)
