...
class LocationService:
    ...
    async def get_city_by_id(
        ...
        city = await self.repository.get_city_by_id(
            city_id
        )
    ...
    async def create_city(
        ...
        existing_city = await self.repository.get_city_by_name(
            name
        )
        ...
        return await self.repository.create_city(
            city
        )
    ...
    async def update_city(
        ...
        city = await self.get_city_by_id(
            city_id
        )
        ...
        if "is_active" in data_dict:
            city.is_active = data_dict[
                "is_active"
            ]

        return await self.repository.update_city(
            city
        )
    ...
    async def get_district_by_id(
        ...
        district = await self.repository.get_district_by_id(
            district_id
        )
    ...
    async def create_district(
        ...
        return await self.repository.create_district(
            district
        )
    ...
    async def update_district(
        ...
        district = await self.get_district_by_id(
            district_id
        )
        ...
        if "name" in data_dict:
            ...
            if (
                existing_district is not None
                and existing_district.id != district.id
            ):
                raise DistrictAlreadyExistsError
        ...
        if "is_active" in data_dict:
            district.is_active = data_dict[
                "is_active"
            ]

        return await self.repository.update_district(
            district
        )
